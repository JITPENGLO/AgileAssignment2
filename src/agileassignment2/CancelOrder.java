...
public class CancelOrder extends javax.swing.JFrame {
    ...
    public class Order{
        ...
        public Order(String id, String name, String desc, double price, String fType, String type, String img){
            this.id = id;
            this.name = name;
            this.desc = desc;
            this.price = price;
    ...
    public ArrayList OrderList(){
        ...
        Order o1 = new Order("FR0000", "Orchid", "Very beautiful flower", 6.05, "Delivery", "bouquet", "Jack.jpg");
        Order o2 = new Order("FA0001", "Rose", "very romantic", 30.25, "Pickup", "floral arrangement", "Rose.jpg");
        Order o3 = new Order("FB0002", "Lily", "Very special flower", 10.95, "Delivery", "fresh flowers", "Lily.jpg");
        Order o4 = new Order("FK0003", "Sunflower", "Very ...", 5.55, "Pickup ", "bouquet", "Sunflower.jpg");
    ...
    public void addRowToTable(){
        ...
        for(int i=0; i<order.size(); i++){
            ...
            rowData[5] = order.get(i).fType;
            rowData[6] = order.get(i).img;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Description", "Price(RM)", "Order Type", "Flower Type", "Picture"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.String.class, java.lang.String.class, java.lang.Byte.class
            };
