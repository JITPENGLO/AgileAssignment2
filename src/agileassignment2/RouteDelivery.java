...
public class RouteDelivery extends javax.swing.JFrame {
    ...
    public class Delivery{
        ...
        public Delivery(String OrderId, String custID, String custName, String date, String address, String postCode, double totalPrice){
    ...
    public ArrayList DeliveryList(){
        ...
        Delivery d5 = new Delivery("OR0005", "CU1045", "Tan Hooi Xin", "3/12/2018", "No 3 Jalan SP 3/1 Taman Segar Perdana", "43100" , 5.00);
        Delivery d6 = new Delivery("OR0006", "CU1103", "Yip Kin Lit",  "1/12/2018", "No 5 Jalan SP 3/1 Taman Segar Perdana", "43100" , 30.00);
    ...
    private void jbtSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtSearchActionPerformed
        ...
        for(int i = 0; i < list.size(); i++){
            if(jtfPostCode.getText().equals(list.get(i).postCode)){
